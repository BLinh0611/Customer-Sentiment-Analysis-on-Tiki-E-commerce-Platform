...
# Kiểm tra kích thước sau khi cân bằng
print("Số lượng nhãn trong tập huấn luyện sau khi cân bằng:", Counter(y_resampled))
...
# -------------------------------------------
param_grid_lr = {
    'C': [ 0.1, 1, 10] # Tham số C cho Logistic Regression  
}
start_lr=time.time()
